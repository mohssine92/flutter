...
class _AnimatedContainerPageState extends State<AnimatedContainerPage> { // estado 
  ...
  @override
  Widget build(BuildContext context) { // creacion de vista
    return Scaffold(
      appBar: AppBar(
        title: const Text('Animated Container'),
      ),
      body: Center(
        child: AnimatedContainer( // habia container por lo hace si animacion 
          duration: const Duration( seconds: 1 ), // tiempo va a tardar de cambia de estado anterior a nuevo estado 
      ...
      floatingActionButton: FloatingActionButton( //al scaffold()
  ...
  void _cambiarForma() {
    ...
    setState(() {  // cambiar estae de props definidas en el state de este container widget ..
