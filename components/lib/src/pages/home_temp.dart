...
class HomePageTemp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView( // similar a Row y colomn para hacer scrol 
  ...
  List<Widget> _crearItems() { // regresa list de widget
    ...
    for (String opt in opciones) {
      ...
      lista..add( tempWidget ) // push .. encadenar de pushes
  ...
  List<Widget> _crearItemsCorta() {
    ...
    return opciones.map( ( item ){  // usar metodo map viene en todas las listas
