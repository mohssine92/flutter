...
void main() async {
  ...
  final prefs = PreferenciasUsuario(); // singlton + es lugar superior y me permite ejecuatr tareas asyncronas 
  await prefs.initPrefs(); // cargar initializar prefrencias
