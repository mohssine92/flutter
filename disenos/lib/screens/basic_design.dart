    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // Imagen
          Image(image: AssetImage('assets/landscape.jpg')), // because he is in the assets
...
class Title extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row( // envolver en container con fin de : modify stetic , posiciones , padding , separaciones , 
        children: [

          Column(
            crossAxisAlignment: CrossAxisAlignment.start, // como se alinean los elementos de la columna h
          ...
          Expanded(child: Container()), // expanded toma un widget y lo expande todo lo qeu pueda
