...
import 'package:app_qr/providers/db_provider.dart'; // modelo db  sqlite dispositivo 

class ScanListProvider extends ChangeNotifier {

  List<ScanModel> scans = [];
  String tipoSeleccionado = 'http'; // por defect // F:cargar por tipo lo mofifica

  Future<ScanModel> nuevoScan( String valor ) async { // valor producto del button sacan
    ...
    if ( tipoSeleccionado == nuevoScan.tipo ) {
         scans.add(nuevoScan);
      notifyListeners();
      // porque si estoy en direcciones y escaneo geolocation no tengo porque actualizar xu en absoluto - actualizamos cuandop cambiamos opcion 
  ...
  cargarScans() async {
    ...
    this.scans = [...scans]; // remplazar estado interior pero el nuevo estado que esta en aqui
    notifyListeners();
  }
